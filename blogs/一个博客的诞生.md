...
如果你像我一样是接受不了github自带域名**[Yun-Tianming.github.io](https://github.com/Yun-Tianming/Yun-Tianming.github.io)**，想更优雅地进入自己的博客[https://blog.luofu.org/](https://blog.luofu.org/)，域名解析则是一个必不可少的步骤。需要如下几步实现：
...
如果你想[像我一样](https://blog.luofu.org/comments/)把这个**评论系统嵌入自己的博客**的话，可以试试我的方法（ps，这只是我的尝试，并没有官方文档依据，欢迎大家分享自己的做法）：
